...
function startTyping() {
    ...
    const texts = [
		...
		"b) köszöni, és jól esik neki, hogy értesítetted az e-mail cím változásról.",
		"c) közelmúltbéli üzeneted olvasásakor hangosan felnevetett ezen a sorodon: \"hátha ismét arra vetemedne, hogy ilyen kockázatos vásárlásba vágja a fejszéjét\" :-D :-D :-D", 
		"",
		"Teljes meglepődéssel konstatáltam, hogy befejezed a webáruházi ténykedést,",
		"de megértem, hiszen a notórius reklamálók (tudom, hogy tudod, hogy kire célzok…) próbára tehették a türelmedet.",
		"",
		...
		"",
		":-) Éééééés…",
		"…zárszóként hadd biztosítsalak arról, hogy a start gombon a \"megnyitás\" szót szándékosan írtam külön :-D,", 
	    	"de őszintén remélem, hogy ezzel az ártatlan csínytevéssel nem okoztam tartós szívritmuszavart. :-D (Max. átmenetit.)",
