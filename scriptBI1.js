...
function startTyping() {
    ...
    const texts = [
		...
		"Ez a Béta verzióm.",
	    	"És a Viki háta mögötti titkos magánakcióm.",
        	"Postafiókod felől huzamosabb ideje egyirányú adatáramlás figyelhető meg Viki postafiókja felé.",
	    	"A visszirányú kommunikáció tartós hiánya zavart okozhat az adatfeldolgozási protokollban, ezért – és csakis a kommunikációs aszimmetria vészmegoldás jellegű feloldása érdekében – ezúton tájékoztatlak az alábbiakról:",
		"a) Viki jó szívvel gondol rád. :-)",
		"b) köszöni, hogy értesítetted az elérhetőséged megváltozásáról.",
		"c) közelmúltbeli leveled elmosolyogtatta, egy sora különösen megnevettette /idézem: \"hátha ismét arra vetemedne, hogy ilyen kockázatos vásárlásba vágja a fejszéjét\"/ :-D :-D :-D", 
		"",
		...
		"Bízom benne, hogy sárgatinta-fronton is van pozitív fejlemény.",
	    	"",
	    	"Őszintén meglepett, hogy befejezted a webáruházi tevékenységedet. Egyúttal teljesen érthető, hiszen a notórius reklamálók (tudod, kire célzok...) biztosan szereztek neked pár ősz hajszálat.",
		"",
